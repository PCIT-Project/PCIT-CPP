...
namespace pcit::core{
	...
	struct UniqueID{
		public:
			...
			class Iterator{
			    public:
			        ...
			        [[nodiscard]] constexpr auto operator*() const -> const SelfReference& {
			        ...
			        [[nodiscard]] constexpr auto operator==(const Iterator& rhs) const -> bool {
		...
		public:
			...
			[[nodiscard]] constexpr auto operator==(const ThisT& rhs) const -> bool {
			...
			[[nodiscard]] constexpr auto get() const -> BaseT { return this->internal_id; }
