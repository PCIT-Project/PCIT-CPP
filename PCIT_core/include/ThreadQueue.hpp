...
namespace pcit::core{
	...
	class ThreadQueue{
		...
		public:
			...
			[[nodiscard]] static auto optimalNumThreads() -> uint32_t {
			...
			[[nodiscard]] auto isRunning() const -> bool { return this->priv.workers.empty() == false; }
			[[nodiscard]] auto taskFailed() const -> bool { return this->priv.task_failed; }
		...
		private:
			class Worker{
				public:
					...
					[[nodiscard]] auto is_working() const -> bool {
