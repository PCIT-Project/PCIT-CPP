...
namespace pcit::llvmint{
	...
	struct APFloatBase {
		...
		static const llvmint::fltSemantics &EnumToSemantics(Semantics S);
		static Semantics SemanticsToEnum(const llvmint::fltSemantics &Sem);
		...
		using roundingMode = llvmint::glue::RoundingMode;

		static constexpr roundingMode rmNearestTiesToEven = llvmint::glue::RoundingMode::NearestTiesToEven;
		static constexpr roundingMode rmTowardPositive    = llvmint::glue::RoundingMode::TowardPositive;
		static constexpr roundingMode rmTowardNegative    = llvmint::glue::RoundingMode::TowardNegative;
		static constexpr roundingMode rmTowardZero        = llvmint::glue::RoundingMode::TowardZero;
		static constexpr roundingMode rmNearestTiesToAway = llvmint::glue::RoundingMode::NearestTiesToAway;
	...
	public:
		...
		opStatus convertToInteger(std::span<integerPart>, unsigned int, bool, roundingMode, bool *) const;
		opStatus convertFromAPInt(const APInt &, bool, roundingMode);
		opStatus convertFromSignExtendedInteger(const integerPart *, unsigned int, bool, roundingMode);
		opStatus convertFromZeroExtendedInteger(const integerPart *, unsigned int, bool, roundingMode);
		// Expected<opStatus> convertFromString(std::string_view, roundingMode);
		...
		/// 1.01E-2              4             2       0.0101
		/// 1.01E-2              4             1       1.01E-2
		void toString(std::string &Str, unsigned FormatPrecision = 0,
	...
	private:
		...
		// bool convertFromStringSpecials(std::string_view str);
		opStatus normalize(roundingMode, lostFraction);
		opStatus addOrSubtract(const IEEEFloat &, roundingMode, bool subtract);
		opStatus handleOverflow(roundingMode);
		bool roundAwayFromZero(roundingMode, lostFraction, unsigned int) const;
		opStatus convertToSignExtendedInteger(std::span<integerPart>, unsigned int, bool, roundingMode, bool *) const;
		opStatus convertFromUnsignedParts(const integerPart *, unsigned int, roundingMode);
		// Expected<opStatus> convertFromHexadecimalString(std::string_view, roundingMode);
		// Expected<opStatus> convertFromDecimalString(std::string_view, roundingMode);
	...
	public:
		...
		opStatus convertToInteger(
			std::span<integerPart> Input, unsigned int Width, bool IsSigned, roundingMode RM, bool *IsExact
		) const;
		opStatus convertFromAPInt(const APInt &Input, bool IsSigned, roundingMode RM);
		opStatus convertFromSignExtendedInteger(
		...
		void toString(std::string &Str, unsigned FormatPrecision,
	...
	class APFloat : public APFloatBase {
		...
		union Storage {
			...
			explicit Storage(DoubleAPFloat F, const fltSemantics &S)
					: Double(std::move(F)) {
				evo::debugAssert(&S == &PPCDoubleDouble());
			}
		...
		cmpResult compareAbsoluteValue(const APFloat &RHS) const {
			evo::debugAssert(&getSemantics() == &RHS.getSemantics() &&
	...
	public:
		...
		// APFloat(const fltSemantics &Semantics, std::string_view S);
		...
		APFloat(const fltSemantics &Semantics, uninitializedTag) : U(Semantics, uninitialized) {}
		...
		opStatus fusedMultiplyAdd(const APFloat &Multiplicand, const APFloat &Addend,
															roundingMode RM) {
			evo::debugAssert(&getSemantics() == &Multiplicand.getSemantics() &&
						 "Should only call on APFloats with the same semantics");
			evo::debugAssert(&getSemantics() == &Addend.getSemantics() &&
						 "Should only call on APFloats with the same semantics");
			if (usesLayout<IEEEFloat>(getSemantics()))
				return U.IEEE.fusedMultiplyAdd(Multiplicand.U.IEEE, Addend.U.IEEE, RM);
			if (usesLayout<DoubleAPFloat>(getSemantics()))
				return U.Double.fusedMultiplyAdd(Multiplicand.U.Double, Addend.U.Double, RM);
			evo::debugFatalBreak("Unexpected semantics");
		}
		opStatus roundToIntegral(roundingMode RM) {
		...
		opStatus convert(const fltSemantics &ToSemantics, roundingMode RM,
										 bool *losesInfo);
		opStatus convertToInteger(std::span<integerPart> Input,
		...
		opStatus convertFromSignExtendedInteger(
			...
			APFLOAT_DISPATCH_ON_SEMANTICS(convertFromSignExtendedInteger(Input, InputSize, IsSigned, RM));
		}
		opStatus convertFromZeroExtendedInteger(
			const integerPart *Input, unsigned int InputSize, bool IsSigned, roundingMode RM
		) {
			APFLOAT_DISPATCH_ON_SEMANTICS(convertFromZeroExtendedInteger(Input, InputSize, IsSigned, RM));
		}
		// Expected<opStatus> convertFromString(std::string_view, roundingMode);
		APInt bitcastToAPInt() const {
