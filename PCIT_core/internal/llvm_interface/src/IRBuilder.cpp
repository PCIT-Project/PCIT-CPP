...
namespace pcit::llvmint{
	...
	auto IRBuilder::createBranch(const BasicBlock& block) -> BranchInst {
		return this->builder->CreateBr(block.native());
	}
	...
	auto IRBuilder::createIntrinsicCall(
		...
		const llvm::Intrinsic::ID intrinsic_id = [&]() -> llvm::Intrinsic::ID {
			switch(id){
				...
				case IntrinsicID::WASM_MEMORY_GROW: return llvm::Intrinsic::WASMIntrinsics::wasm_memory_grow;
				case IntrinsicID::WASM_MEMORY_SIZE: return llvm::Intrinsic::WASMIntrinsics::wasm_memory_size;
			}
