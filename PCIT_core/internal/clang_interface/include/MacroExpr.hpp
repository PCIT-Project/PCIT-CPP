...
namespace pcit::clangint{
	...
	class MacroExprBuffer{
		public:
			...
			[[nodiscard]] static auto createNone() -> MacroExpr {
			...
			[[nodiscard]] static auto createBool(bool value) -> MacroExpr {
				return MacroExpr(MacroExpr::Kind::BOOL, value);
			}
			[[nodiscard]] static auto getBool(MacroExpr expr) -> bool {
			...
			[[nodiscard]] auto createInteger(auto&&... args) -> MacroExpr {
			...
			[[nodiscard]] auto getInteger(MacroExpr expr) const -> const MacroExpr::Integer& {
			...
			[[nodiscard]] auto createFloat(auto&&... args) -> MacroExpr {
			...
			[[nodiscard]] auto getFloat(MacroExpr expr) const -> const MacroExpr::Float& {
