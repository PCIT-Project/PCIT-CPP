...
namespace pcit::panther{
	...
	class SemanticAnalyzer{
		public:
			[[nodiscard]] static auto create(Context& context, SymbolProc::ID symbol_proc_id)
			-> SemanticAnalyzer {
		...
		private:
			...
			[[nodiscard]] auto instr_suspend_symbol_proc() -> Result;
			...
			[[nodiscard]] auto instr_struct_decl(const Instruction::StructDecl<IS_INSTANTIATION>& instr) -> Result;
			[[nodiscard]] auto instr_struct_def() -> Result;
			[[nodiscard]] auto instr_struct_created_sepcial_members_pir_if_needed() -> Result;
			[[nodiscard]] auto instr_template_struct(const Instruction::TemplateStruct& instr) -> Result;
			[[nodiscard]] auto instr_union_decl(const Instruction::UnionDecl& instr) -> Result;
			...
			[[nodiscard]] auto instr_func_extern(const Instruction::FuncExtern& instr) -> Result;
			...
			[[nodiscard]] auto instr_func_body_setup(const Instruction::FuncBodySetup& instr) -> Result;
			[[nodiscard]] auto instr_func_def(const Instruction::FuncDef& instr) -> Result;
			[[nodiscard]] auto instr_func_prepare_comptime_pir_if_needed(
				const Instruction::FuncPrepareComptimePIRIfNeeded& instr
			) -> Result;
			[[nodiscard]] auto instr_func_comptime_pir_ready_if_needed() -> Result;
			...
			[[nodiscard]] auto instr_deleted_special_method(const Instruction::DeletedSpecialMethod& instr) -> Result;

			[[nodiscard]] auto instr_interface_prepare(const Instruction::InterfacePrepare& instr) -> Result;
			[[nodiscard]] auto instr_func_alias_def(const Instruction::FuncAliasDef& instr) -> Result;
			[[nodiscard]] auto instr_interface_decl() -> Result;
			[[nodiscard]] auto instr_interface_def() -> Result;
			[[nodiscard]] auto instr_interface_func_def(const Instruction::InterfaceFuncDef& instr) -> Result;
			[[nodiscard]] auto instr_interface_impl_decl(const Instruction::InterfaceImplDecl& instr) -> Result;
			[[nodiscard]] auto instr_interface_in_def_impl_decl(const Instruction::InterfaceInDefImplDecl& instr)
				-> Result;
			[[nodiscard]] auto instr_interface_deducer_impl_instantiation_decl(
				const Instruction::InterfaceDeducerImplInstantiationDecl& instr
			) -> Result;
			[[nodiscard]] auto instr_interface_impl_method_lookup(const Instruction::InterfaceImplMethodLookup& instr)
				-> Result;
			[[nodiscard]] auto instr_interface_in_def_impl_method(const Instruction::InterfaceInDefImplMethod& instr)
				-> Result;
			[[nodiscard]] auto instr_interface_impl_def(const Instruction::InterfaceImplDef& instr) -> Result;
			[[nodiscard]] auto instr_interface_impl_comptime_pir() -> Result;



			[[nodiscard]] auto instr_local_var(const Instruction::LocalVar& instr) -> Result;
			[[nodiscard]] auto instr_local_func_alias(const Instruction::LocalFuncAlias& instr) -> Result;
			[[nodiscard]] auto instr_local_alias(const Instruction::LocalAlias& instr) -> Result;
			[[nodiscard]] auto instr_return(const Instruction::Return& instr) -> Result;
			[[nodiscard]] auto instr_labeled_return(const Instruction::LabeledReturn& instr) -> Result;
			[[nodiscard]] auto instr_error(const Instruction::Error& instr) -> Result;
			[[nodiscard]] auto instr_unreachable(const Instruction::Unreachable& instr) -> Result;
			[[nodiscard]] auto instr_break(const Instruction::Break& instr) -> Result;
			...
			[[nodiscard]] auto instr_end_cond() -> Result;
			...
			[[nodiscard]] auto instr_end_stmt_block(const Instruction::EndStmtBlock& instr) -> Result;
			[[nodiscard]] auto instr_func_call(const Instruction::FuncCall& instr) -> Result;
			[[nodiscard]] auto instr_assignment(const Instruction::Assignment& instr) -> Result;
			[[nodiscard]] auto instr_assignment_new(const Instruction::AssignmentNew& instr) -> Result;
			[[nodiscard]] auto instr_assignment_copy(const Instruction::AssignmentCopy& instr) -> Result;
			[[nodiscard]] auto instr_assignment_move(const Instruction::AssignmentMove& instr) -> Result;
			[[nodiscard]] auto instr_assignment_forward(const Instruction::AssignmentForward& instr) -> Result;
			...
			[[nodiscard]] auto instr_require_this_def() -> Result;
			[[nodiscard]] auto instr_wait_on_sub_symbol_proc_decl(const Instruction::WaitOnSubSymbolProcDecl& instr)
				-> Result;
			[[nodiscard]] auto instr_wait_on_sub_symbol_proc_def(const Instruction::WaitOnSubSymbolProcDef& instr)
				-> Result;

			template<bool IS_COMPTIME, bool ERRORS>
			[[nodiscard]] auto instr_func_call_expr(const Instruction::FuncCallExpr<IS_COMPTIME, ERRORS>& instr)
				-> Result;

			template<bool IS_COMPTIME>
			[[nodiscard]] auto builtin_type_method_call(
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto interface_func_call(
				const TermInfo& target_term_info,
				evo::SmallVector<sema::Expr>&& args,
			...
			[[nodiscard]] auto instr_comptime_func_call_run(const Instruction::ComptimeFuncCallRun& instr) -> Result;

			template<Instruction::Language LANGUAGE>
			[[nodiscard]] auto instr_import(const Instruction::Import<LANGUAGE>& instr) -> Result;

			[[nodiscard]] auto instr_is_macro_defined(const Instruction::IsMacroDefined& instr) -> Result;
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto instr_template_intrinsic_func_call_expr(
				const Instruction::TemplateIntrinsicFuncCallExpr<IS_COMPTIME>& instr
			) -> Result;

			template<bool IS_COMPTIME>
			[[nodiscard]] auto instr_indexer(const Instruction::Indexer<IS_COMPTIME>& instr) -> Result;

			[[nodiscard]] auto instr_templated_term(const Instruction::TemplatedTerm& instr) -> Result;

			template<bool WAIT_FOR_DEF>
			[[nodiscard]] auto instr_templated_term_wait(const Instruction::TemplatedTermWait<WAIT_FOR_DEF>& instr)
				-> Result;

			[[nodiscard]] auto instr_push_template_decl_instantiation_types_scope() -> Result;
			[[nodiscard]] auto instr_pop_template_decl_instantiation_types_scope() -> Result;
			[[nodiscard]] auto instr_add_template_decl_instantiation_type(
				const Instruction::AddTemplateDeclInstantiationType& instr
			) -> Result;

			template<bool IS_COMPTIME>
			[[nodiscard]] auto instr_copy(const Instruction::Copy<IS_COMPTIME>& instr) -> Result;

			[[nodiscard]] auto instr_move(const Instruction::Move& instr) -> Result;
			[[nodiscard]] auto instr_forward(const Instruction::Forward& instr) -> Result;
			[[nodiscard]] auto instr_addr_of(const Instruction::AddrOf& instr) -> Result;

			template<bool IS_COMPTIME>
			[[nodiscard]] auto instr_prefix_negate(const Instruction::PrefixNegate<IS_COMPTIME>& instr) -> Result;

			template<bool IS_COMPTIME>
			[[nodiscard]] auto instr_prefix_not(const Instruction::PrefixNot<IS_COMPTIME>& instr) -> Result;
			...
			[[nodiscard]] auto instr_comptime_struct_new_run(const Instruction::ComptimeStructNewRun& instr) -> Result;
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto instr_accessor(const Instruction::Accessor<IS_COMPTIME>& instr) -> Result;

			[[nodiscard]] auto instr_primitive_type(const Instruction::PrimitiveType& instr) -> Result;
			...
			[[nodiscard]] auto instr_qualified_type_term(const Instruction::QualifiedTypeTerm& instr) -> Result;
			[[nodiscard]] auto instr_base_type_ident(const Instruction::BaseTypeIdent& instr) -> Result;

			template<bool NEEDS_DEF>
			[[nodiscard]] auto instr_ident(const Instruction::Ident<NEEDS_DEF>& instr) -> Result;

			[[nodiscard]] auto instr_intrinsic(const Instruction::Intrinsic& instr) -> Result;

			template<bool NEEDS_DEF>
			[[nodiscard]] auto instr_type_this(const Instruction::TypeThis<NEEDS_DEF>& instr) -> Result;

			[[nodiscard]] auto instr_literal(const Instruction::Literal& instr) -> Result;
			[[nodiscard]] auto instr_uninit(const Instruction::Uninit& instr) -> Result;
			[[nodiscard]] auto instr_zeroinit(const Instruction::Zeroinit& instr) -> Result;
			[[nodiscard]] auto instr_this(const Instruction::This& instr) -> Result;
			[[nodiscard]] auto instr_type_deducer(const Instruction::TypeDeducer& instr) -> Result;
			[[nodiscard]] auto instr_expr_deducer(const Instruction::ExprDeducer& instr) -> Result;
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto module_accessor(
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto builtin_module_accessor(
				const Instruction::Accessor<IS_COMPTIME>& instr,
				std::string_view rhs_ident_str,
				const TermInfo& lhs
			) -> Result;
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto optional_accessor(
				const Instruction::Accessor<IS_COMPTIME>& instr,
				std::string_view rhs_ident_str,
				const TermInfo& lhs,
				TypeInfo::ID decayed_lhs_type_id,
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto struct_accessor(
				const Instruction::Accessor<IS_COMPTIME>& instr,
				std::string_view rhs_ident_str,
				const TermInfo& lhs,
				TypeInfo::ID decayed_lhs_type_id,
			...
			template<bool IS_COMPTIME>
			[[nodiscard]] auto array_ref_accessor(
				const Instruction::Accessor<IS_COMPTIME>& instr,
				std::string_view rhs_ident_str,
				const TermInfo& lhs,
				TypeInfo::ID decayed_lhs_type_id,
			...
			[[nodiscard]] auto get_current_scope_level() const -> sema::ScopeLevel&;
			[[nodiscard]] auto push_scope_level(sema::StmtBlock* stmt_block = nullptr) -> void;
			[[nodiscard]] auto push_scope_level(
				sema::StmtBlock& stmt_block, Token::ID label, sema::ScopeLevel::LabelNode label_node
			) -> void;
			[[nodiscard]] auto push_scope_level(sema::StmtBlock* stmt_block, const auto& encapsulating_symbol_id)
				-> void;
			...
			[[nodiscard]] auto get_special_member_call_dependents(
			...
			[[nodiscard]] auto currently_in_unsafe() const -> bool;


			[[nodiscard]] auto currently_in_func() const -> bool;

			[[nodiscard]] auto get_current_func() -> sema::Func&;
			...
			template<bool NEEDS_DEF>
			[[nodiscard]] auto lookup_ident_impl(Token::ID ident) -> evo::Expected<TermInfo, Result>;
			...
			[[nodiscard]] auto analyze_expr_ident_in_scope_level(
			...
			template<bool NEEDS_DEF>
			[[nodiscard]] auto wait_on_symbol_proc(
			...
			[[nodiscard]] auto select_func_overload(
			...
			struct FuncCallImplData{
				...
				[[nodiscard]] auto is_src_func() const -> bool { return this->selected_func_id.has_value(); }
			};
			template<bool IS_COMPTIME, bool ERRORS>
			...
			[[nodiscard]] auto type_implements_interface(
			...
			struct DeducerMatchOutput{
				...
				[[nodiscard]] auto outcome() const -> Outcome { return this->_outcome; }
			...
			[[nodiscard]] auto deducer_matches_and_extract(TypeInfo::ID deducer_id, TypeInfo::ID got_type_id)
				-> DeducerMatchOutput;

			[[nodiscard]] auto add_deduced_terms_to_scope(
				evo::ArrayProxy<DeducerMatchOutput::DeducedTerm> deduced_terms
			) -> evo::Result<>;


			[[nodiscard]] auto create_prefix_overload(
			...
			[[nodiscard]] auto infix_overload_impl(
			...
			[[nodiscard]] auto prefix_overload_impl(
			...
			[[nodiscard]] auto comptime_infix_math(
			...
			[[nodiscard]] auto impl_instr_interface_impl_def_non_deducer(const Instruction::InterfaceImplDef& instr)
				-> Result;
			[[nodiscard]] auto impl_instr_interface_impl_def_deducer() -> Result;
			...
			[[nodiscard]] auto analyze_global_var_attrs(
			...
			[[nodiscard]] auto analyze_var_attrs(
				const AST::VarDef& var_def, evo::ArrayProxy<Instruction::AttributeParams> attribute_params_info
			) -> evo::Result<VarAttrs>;
			...
			[[nodiscard]] auto analyze_alias_attrs(
			...
			[[nodiscard]] auto analyze_local_alias_attrs(
				const AST::AliasDef& alias_def, evo::ArrayProxy<Instruction::AttributeParams> attribute_params_info
			...
			[[nodiscard]] auto analyze_func_param_attrs(
			...
			struct TypeCheckInfo{
				...
				public:
					[[nodiscard]] static auto fail() -> TypeCheckInfo {
						return TypeCheckInfo(false, false, {}, std::nullopt, std::monostate());
					}
					[[nodiscard]] static auto fail(Result result) -> TypeCheckInfo {
						return TypeCheckInfo(false, false, {}, result, std::monostate());
					}

					[[nodiscard]] static auto success(bool requires_implicit_conversion) -> TypeCheckInfo {
					...
					[[nodiscard]] static auto success(InitAssignFunc init_func) -> TypeCheckInfo {
						return TypeCheckInfo(true, true, {}, std::nullopt, init_func);
					}
					[[nodiscard]] static auto success(AssignFunc assign_func) -> TypeCheckInfo {
			...
			[[nodiscard]] auto check_type_qualifiers(
				evo::ArrayProxy<TypeInfo::Qualifier> qualifiers, const auto& location
			) -> evo::Result<>;


			[[nodiscard]] auto check_term_isnt_type(const TermInfo& term_info, const auto& location) -> evo::Result<>;


			[[nodiscard]] auto add_ident_to_scope(
			...
			[[nodiscard]] auto print_term_type(
				const TermInfo& term_info, std::optional<unsigned> multi_type_index = std::nullopt
			) const -> std::string;


			[[nodiscard]] auto check_scope_isnt_terminated(const auto& location) -> evo::Result<>;
			...
			[[nodiscard]] auto get_location(const Diagnostic::Location& location) const -> Diagnostic::Location {
				return location;
			}

			[[nodiscard]] auto get_location(const sema::ScopeLevel::ModuleInfo& module_info) const
			-> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(const sema::ScopeLevel::TemplateTypeParam& template_type_param) const
			-> Diagnostic::Location {
				return this->get_location(template_type_param.location);
			}

			[[nodiscard]] auto get_location(const sema::ScopeLevel::TemplateExprParam& template_expr_param) const
			-> Diagnostic::Location {
				return this->get_location(template_expr_param.location);
			}

			[[nodiscard]] auto get_location(const sema::ScopeLevel::DeducedType& deduced_type) const
			-> Diagnostic::Location {
				return this->get_location(deduced_type.location);
			}

			[[nodiscard]] auto get_location(const sema::ScopeLevel::DeducedExpr& deduced_expr) const
			-> Diagnostic::Location {
				return this->get_location(deduced_expr.location);
			}

			[[nodiscard]] auto get_location(const sema::ScopeLevel::MemberVar& member_var) const
			-> Diagnostic::Location {
				return this->get_location(member_var.location);
			}

			[[nodiscard]] auto get_location(const sema::ScopeLevel::UnionField& union_field) const
			-> Diagnostic::Location {
				return this->get_location(union_field.location);
			}

			[[nodiscard]] auto get_location(const sema::ScopeLevel::ForUnrollIndex& for_unroll_index) const
			-> Diagnostic::Location {
				return this->get_location(for_unroll_index.location);
			}

			[[nodiscard]] auto get_location(sema::Func::ID func_id) const -> Diagnostic::Location {
				return Diagnostic::Location::get(func_id, this->context);
			}

			[[nodiscard]] auto get_location(const sema::Func& func) const -> Diagnostic::Location {
				return Diagnostic::Location::get(func, this->context);
			}

			[[nodiscard]] auto get_location(sema::FuncAlias::ID func_alias_id) const -> Diagnostic::Location {
				return Diagnostic::Location::get(func_alias_id, this->context);
			}

			[[nodiscard]] auto get_location(const sema::FuncAlias& func_alias) const -> Diagnostic::Location {
				return Diagnostic::Location::get(func_alias, this->context);
			}

			[[nodiscard]] auto get_location(const sema::TemplatedFuncID& templated_func) const -> Diagnostic::Location {
				return Diagnostic::Location::get(templated_func, this->context);
			}

			[[nodiscard]] auto get_location(const sema::GlobalVarID& var) const -> Diagnostic::Location {
				return Diagnostic::Location::get(var, this->context);
			}

			[[nodiscard]] auto get_location(const sema::VarID& var) const -> Diagnostic::Location {
				return Diagnostic::Location::get(var, this->source, this->context);
			}

			[[nodiscard]] auto get_location(sema::ParamID param_id) const -> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::VariadicParamID param_id) const -> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::ScopeLevel::ExtractedVariadicParam extracted_variadic_param) const
			-> Diagnostic::Location {
				return this->get_location(extracted_variadic_param.param_id);
			}

			[[nodiscard]] auto get_location(sema::ReturnParam::ID return_param_id) const -> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::ErrorReturnParam::ID error_param_id) const -> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::BlockExprOutput::ID block_expr_output_id) const
			-> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::ExceptParamID except_param_id) const -> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::ForParamID for_param_id) const -> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(BaseType::Alias::ID alias_id) const -> Diagnostic::Location {
				return Diagnostic::Location::get(alias_id, this->context);
			}
			[[nodiscard]] auto get_location(const BaseType::Alias& alias_type) const -> Diagnostic::Location {
				return Diagnostic::Location::get(alias_type, this->context);
			}

			[[nodiscard]] auto get_location(BaseType::DistinctAlias::ID distinct_alias_id) const
			-> Diagnostic::Location {
				return Diagnostic::Location::get(distinct_alias_id, this->context);
			}
			[[nodiscard]] auto get_location(const BaseType::DistinctAlias& distinct_alias_type) const
			-> Diagnostic::Location {
				return Diagnostic::Location::get(distinct_alias_type, this->context);
			}

			[[nodiscard]] auto get_location(BaseType::Struct::ID struct_id) const -> Diagnostic::Location {
				return Diagnostic::Location::get(struct_id, this->context);
			}
			[[nodiscard]] auto get_location(const BaseType::Struct& struct_type) const -> Diagnostic::Location {
				return Diagnostic::Location::get(struct_type, this->context);
			}

			[[nodiscard]] auto get_location(BaseType::Union::ID union_id) const -> Diagnostic::Location {
				return Diagnostic::Location::get(union_id, this->context);
			}
			[[nodiscard]] auto get_location(const BaseType::Union& union_type) const -> Diagnostic::Location {
				return Diagnostic::Location::get(union_type, this->context);
			}

			[[nodiscard]] auto get_location(BaseType::Enum::ID enum_id) const -> Diagnostic::Location {
				return Diagnostic::Location::get(enum_id, this->context);
			}
			[[nodiscard]] auto get_location(const BaseType::Enum& enum_type) const -> Diagnostic::Location {
				return Diagnostic::Location::get(enum_type, this->context);
			}

			[[nodiscard]] auto get_location(BaseType::Interface::ID interface_id) const -> Diagnostic::Location {
				return Diagnostic::Location::get(interface_id, this->context);
			}

			[[nodiscard]] auto get_location(const BaseType::Interface& interface_type) const -> Diagnostic::Location {
				return Diagnostic::Location::get(interface_type, this->context);
			}

			[[nodiscard]] auto get_location(sema::TemplatedStruct::ID templated_struct_id) const
			-> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::StructTemplateAlias::ID struct_template_alias_id) const
			-> Diagnostic::Location {
			...
			[[nodiscard]] auto get_location(sema::ScopeLevel::ValueStateID value_state_id) const
			-> Diagnostic::Location {
