...
namespace pcit::panther{
	...
	class Parser{
		...
		private:
			...
			EVO_NODISCARD auto parse_struct_def(const AST::Node& ident) -> Result;
			EVO_NODISCARD auto parse_union_def(const AST::Node& ident) -> Result;
			EVO_NODISCARD auto parse_enum_def(const AST::Node& ident) -> Result;
			EVO_NODISCARD auto parse_type_alias(const AST::Node& ident) -> Result;
			...
			EVO_NODISCARD auto parse_for() -> Result;
			EVO_NODISCARD auto parse_switch() -> Result;
			template<bool IS_ERROR_DEFER> EVO_NODISCARD auto parse_defer() -> Result;
			EVO_NODISCARD auto parse_try_stmt() -> Result;
			EVO_NODISCARD auto parse_unsafe() -> Result;
			...
			EVO_NODISCARD auto parse_type_this() -> Result;
