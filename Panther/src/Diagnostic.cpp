...
namespace pcit::panther{
	...
	auto Diagnostic::Location::get(const AST::Switch& switch_stmt, const Source& src) -> Location {
		return Location::get(switch_stmt.keyword, src);
	}

	auto Diagnostic::Location::get(const AST::WhenSwitch& when_switch_stmt, const Source& src) -> Location {
		return Location::get(when_switch_stmt.keyword, src);
	}
