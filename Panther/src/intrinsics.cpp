...
namespace pcit::panther{
	...
	auto TemplateIntrinsicFunc::initLookupTableIfNeeded() -> void {
		...
		template_intrinsic_kinds = std::unordered_map<std::string_view, Kind>{
			...
			{"isRuntimeDefaultInitializable",   Kind::IS_RUNTIME_DEFAULT_INITIALIZABLE},
			...
			{"isRuntimeMovable",                Kind::IS_RUNTIME_MOVABLE},
			...
			{"isRuntimeComparable",             Kind::IS_RUNTIME_COMPARABLE},
