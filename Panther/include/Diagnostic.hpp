	...
	struct Diagnostic{
		...
		class Location{
			...
			public:
				...
				template<class T>
				[[nodiscard]] auto is() const -> bool { return this->variant.is<T>(); }

				template<class T>
				[[nodiscard]] auto as() -> T& { return this->variant.as<T>(); }

				template<class T>
				[[nodiscard]] auto as() const -> const T& { return this->variant.as<T>(); }
				...
				// Tokens
				[[nodiscard]] static auto get(Token::ID token_id, const class Source& src) -> Location;

				// AST
				[[nodiscard]] static auto get(const AST::Node& node, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::VarDef& var_def, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::FuncDef& func_def, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::FuncDef::Param& param, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::FuncDef::Return& ret, const class Source& src) -> Location;
				[[nodiscard]] static auto get(
					const AST::DeletedSpecialMethod& deleted_special_method, const class Source& src
				) -> Location;
				[[nodiscard]] static auto get(const AST::FuncAliasDef& alias_def, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::AliasDef& alias_def, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::StructDef& struct_def, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::UnionDef& union_def, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::EnumDef& enum_def, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::InterfaceDef& interface_def, const class Source& src)
					-> Location;
				[[nodiscard]] static auto get(const AST::InterfaceImpl& interface_impl, const class Source& src)
					-> Location;
				...
				[[nodiscard]] static auto get(const AST::Conditional& conditional, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::WhenConditional& when_cond, const class Source& src)
					-> Location;
				...
				[[nodiscard]] static auto get(const AST::Indexer& indexer, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::TemplatedExpr& templated_expr, const class Source& src)
					-> Location;
				[[nodiscard]] static auto get(const AST::Prefix& prefix, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::Infix& infix, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::Postfix& postfix, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::MultiAssign& multi_assign, const class Source& src)
					-> Location;
				[[nodiscard]] static auto get(const AST::New& new_expr, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::ArrayInitNew& new_expr, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::DesignatedInitNew& new_expr, const class Source& src)
					-> Location;
				[[nodiscard]] static auto get(const AST::TryElse& try_expr, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::TryCatch& try_catch, const class Source& src) -> Location;
				...
				[[nodiscard]] static auto get(const AST::Type& type, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::TypeIDConverter& type, const class Source& src) -> Location;
				[[nodiscard]] static auto get(const AST::AttributeBlock::Attribute& attr, const class Source& src)
					-> Location;
				...
				[[nodiscard]] static auto get(sema::GlobalVar::ID global_var_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const sema::GlobalVar& global_var, const class Context& context)
					-> Location;

				[[nodiscard]] static auto get(sema::Func::ID func_id, const class Context& context) -> Location;
				[[nodiscard]] static auto get(const sema::Func& func, const class Context& context) -> Location;

				[[nodiscard]] static auto get(sema::FuncAlias::ID func_alias_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const sema::FuncAlias& func_alias, const class Context& context)
					-> Location;

				[[nodiscard]] static auto get(sema::TemplatedFunc::ID templated_func_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const sema::TemplatedFunc& templated_func, const class Context& context)
					-> Location;

				[[nodiscard]] static auto get(BaseType::Alias::ID alias_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const BaseType::Alias& alias_type, const class Context& context)
					-> Location;
				...
				[[nodiscard]] static auto get(BaseType::Struct::ID struct_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const BaseType::Struct& struct_type, const class Context& context)
					-> Location;

				[[nodiscard]] static auto get(BaseType::Union::ID union_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const BaseType::Union& union_type, const class Context& context)
					-> Location;

				[[nodiscard]] static auto get(BaseType::Enum::ID enum_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const BaseType::Enum& enum_type, const class Context& context)
					-> Location;

				[[nodiscard]] static auto get(BaseType::Interface::ID interface_id, const class Context& context)
					-> Location;
				[[nodiscard]] static auto get(const BaseType::Interface& interface_type, const class Context& context)
					-> Location;
		...
		[[nodiscard]] static auto createFatalMessage(
		...
		[[nodiscard]] static auto printLevel(Level level) -> std::string_view {
			switch(level){
		...
		[[nodiscard]] static auto _debug_analyze_message(std::string_view message) -> void {
