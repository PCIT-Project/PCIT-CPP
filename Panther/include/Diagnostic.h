...
namespace pcit::panther{
	...
	struct Diagnostic{
		...
		enum class Code{
			...
			// misc interface funcs
			SEMA_INTERFACE_FUNC_WRONG_NUM_TEMPLATE_ARGS,
			SEMA_INTERFACE_FUNC_INVALID_TEMPLATE_ARG,
		...
		EVO_NODISCARD static auto printCode(Code code) -> std::string_view {
			switch(code){
				...
				case Code::SEMA_INTERFACE_FUNC_WRONG_NUM_TEMPLATE_ARGS:
				case Code::SEMA_INTERFACE_FUNC_INVALID_TEMPLATE_ARG:
