...
namespace pcit::panther::sema{
	...
	struct Stmt{
		...
		[[nodiscard]] auto tryElseID() const -> TryElseID {
			evo::debugAssert(this->kind() == Kind::TRY_ELSE, "not a try else");
			return this->value.try_else_id;
		}

		[[nodiscard]] auto tryElseInterfaceID() const -> TryElseInterfaceID {
	...
	class StmtBlock{
		...
		public:
			...
			[[nodiscard]] auto begin()        -> evo::SmallVector<Stmt>::iterator       { return this->stmts.begin(); };
			[[nodiscard]] auto begin()  const -> evo::SmallVector<Stmt>::const_iterator { return this->stmts.begin(); };
			[[nodiscard]] auto cbegin() const -> evo::SmallVector<Stmt>::const_iterator { return this->stmts.begin(); };

			[[nodiscard]] auto end()        -> evo::SmallVector<Stmt>::iterator       { return this->stmts.end(); };
			[[nodiscard]] auto end()  const -> evo::SmallVector<Stmt>::const_iterator { return this->stmts.end(); };
			[[nodiscard]] auto cend() const -> evo::SmallVector<Stmt>::const_iterator { return this->stmts.end(); };

			[[nodiscard]] auto empty() const -> bool { return this->stmts.empty(); }
			[[nodiscard]] auto size() const -> size_t { return this->stmts.size(); }

			[[nodiscard]] auto front() const -> Stmt { return this->stmts.front(); }
			[[nodiscard]] auto back() const -> Stmt { return this->stmts.back(); }
