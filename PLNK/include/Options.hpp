...
namespace pcit::plnk{
	...
	struct Target{
		...
		[[nodiscard]] static constexpr auto getDefault() -> Target {
	...
	struct Options{
		...
		[[nodiscard]] auto getTarget() const -> Target { return this->target; }
		...
		[[nodiscard]] auto getWindowsSpecific() -> WindowsSpecific& {
			evo::debugAssert(this->target == Target::WINDOWS, "Not Windows target");
			return this->specific.as<WindowsSpecific>();
		}
		[[nodiscard]] auto getWindowsSpecific() const -> const WindowsSpecific& {
			evo::debugAssert(this->target == Target::WINDOWS, "Not Windows target");
			return this->specific.as<WindowsSpecific>();
		}


		[[nodiscard]] auto getUnixSpecific() -> UnixSpecific& {
			evo::debugAssert(this->target == Target::UNIX, "Not Unix target");
			return this->specific.as<UnixSpecific>();
		}
		[[nodiscard]] auto getUnixSpecific() const -> const UnixSpecific& {
			evo::debugAssert(this->target == Target::UNIX, "Not Unix target");
			return this->specific.as<UnixSpecific>();
		}


		[[nodiscard]] auto getDarwinSpecific() -> DarwinSpecific& {
			evo::debugAssert(this->target == Target::DARWIN, "Not Darwin target");
			return this->specific.as<DarwinSpecific>();
		}
		[[nodiscard]] auto getDarwinSpecific() const -> const DarwinSpecific& {
			evo::debugAssert(this->target == Target::DARWIN, "Not Darwin target");
			return this->specific.as<DarwinSpecific>();
		}


		[[nodiscard]] auto getWebAssemblySpecific() -> WebAssemblySpecific& {
			evo::debugAssert(this->target == Target::WEB_ASSEMBLY, "Not WebAssembly target");
			return this->specific.as<WebAssemblySpecific>();
		}
		[[nodiscard]] auto getWebAssemblySpecific() const -> const WebAssemblySpecific& {
			evo::debugAssert(this->target == Target::WEB_ASSEMBLY, "Not WebAssembly target");
			return this->specific.as<WebAssemblySpecific>();
		}
