...
### pthr
- Added timings to full verbose mode
...
### Panther
- Fixed assignment `new` when used in `try`/`else`
...
### Panther
- Fixed template assignment operator `new`
...
### Panther
- Added erroring `copy`, `move`, and `forward`
...
### Misc
- Updated to [Panther-std v0.0.58.1](https://github.com/PCIT-Project/Panther-std/blob/main/CHANGELOG.md#v0.0.58.1)
...
### Panther
- Added hexadeimal escape sequences
...
### Misc
- Updated to [Panther-std v0.0.53.0](https://github.com/PCIT-Project/Panther-std/blob/main/CHANGELOG.md#v0.0.53.0)
...
### Misc
- Updated to [Panther-std v0.0.40.0](https://github.com/PCIT-Project/Panther-std/blob/main/CHANGELOG.md#v0.0.40.0)
...
### Misc
- Updated to [Panther-std v0.0.39.0](https://github.com/PCIT-Project/Panther-std/blob/main/CHANGELOG.md#v0.0.39.0)
...
### Panther
- Improved function overload resolution when multiple overloads have deducers and at least some have qualifiers
...
### Panther
- Added warning `comptimeSwitchCond`
...
### Misc
- Updated to [Panther-std v0.0.38.0](https://github.com/PCIT-Project/Panther-std/blob/main/CHANGELOG.md#v0.0.38.0)
...
### Misc
- Updated to [Panther-std v0.0.36.0](https://github.com/PCIT-Project/Panther-std/blob/main/CHANGELOG.md#v0.0.36.0)
...
### Panther
- Added `when` `switch` in local scope
...
### Misc
- Fixed windows libc headers to work in C++ mode
...
### Panther
- Fixed missing check if `@panic` is needed
...
### Panther
- Fixed calculating sizes of various types
...
- Changed type of `@build.PantherBuildConfig.output` to `@build.PantherBuildConfigOutput`
- Fixed union designated initializers when the target union type is a type alias

### Misc
- Updated to [Panther-std v0.0.25.0](https://github.com/PCIT-Project/Panther-std/blob/main/CHANGELOG.md#v0.0.25.0)
...
### Panther
- Fixed race condition in semantic analysis of template functions
- Fixed other race condition
...
### Panther
- Added deleting of function overloads
...
### Panther
- Fixed lowering of functions with 0 parameters, returns `Void`, and error returns `Void`
...
### Panther
- Added debug info for block expressions
...
### Panther
- Fixed lowering of function that errors and has an unnamed return value
...
### Panther
- Fixed lowering debug info of `RawPtr`
...
### Panther
- Added debug info for optional types
...
### Panther
- Fixed semantic analysis of try/else
...
### PIR
- Added difference between signed and unsigned integer types
...
### Panther
- Fixed comptime operator `as` of structs
...
### Panther
- Fixed comptime implicit conversion
...
### Panther
- Added comptime struct accessor
...
### Panther
- Removed codes from diagnostics
...
### Panther
- Fixed type aliases of struct templates
...
### PIR
- Added support for non-standard struct names
...
### Panther
- Fixed race condition when using aliases
...
### Panther
- Added overloading of prefix `-`, `~`, and `!`
...
### Panther
- Added try/else statements for interface calls
...
### Panther
- Fixed crashing when printing of AST of try/else statements
...
### Panther
- Fixed not checking for defining `copy`and `move` for where it was explicitly deleted
...
### Panther
- Added composite assignment for builtin types
