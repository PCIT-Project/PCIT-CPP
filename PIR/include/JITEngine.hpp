...
namespace pcit::pir{
	...
	class JITEngine{
		...
		public:
			...
			[[nodiscard]] auto addModule(const class Module& module)
			...
			[[nodiscard]] auto addModuleSubset(const class Module& module, const ModuleSubsets& module_subsets)
				-> evo::Expected<void, evo::SmallVector<std::string>>;

			[[nodiscard]] auto addModuleSubsetWithWeakDependencies(
